...
while numiterations<0 or iteration<numiterations:
    ...
    (avalue,agent_action)  = agentThread.result    # finds the best action for the agent
    (cvalue,client_action)  = clientThread.result  # finds the best action for the client
