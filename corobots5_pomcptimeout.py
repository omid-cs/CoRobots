...
class myThread (threading.Thread):
    ...
    def run(self):
        ...
        if self.threadID=="agentThread":
            self.result = self.tAgent.get_next_action_agent()
        else:
            self.result = self.tAgent.get_next_action_client()
...
class CoRobot(object):
    ...
    def get_next_action_agent(self):
        return self.pomcp_agent.POMCP_search(self.beliefState,self,"agentThread",self.timeout)
